...
public class CharacterMotionCopier : MotionCopierComponent {
...
//            print(forceVector.magnitude);
            ...
            {
                if (!app.Model.RecordModel.CharacterRecordingIsOn)
                {
                    app.Controller.RecordController.StartCharacterRecord();

                    app.Model.RecordModel.recordCharacterFramesNumber = 0;
                }
                
			
                app.Model.RecordModel.recordableCharacterPositions.Add(app.Model.RecordModel.recordCharacterFramesNumber, forceVector * 30);
			
                app.Model.RecordModel.recordCharacterFramesNumber += 1;  
                
                _rigidbody.AddForce(forceVector * 30);
            }
