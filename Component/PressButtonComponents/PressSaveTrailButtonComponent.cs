...
public class PressSaveTrailButtonComponent : PressButtonComponent
{
    ...
    public override void PressButton()
    {
        ...
        app.Controller.RecordController.SaveTrailButtonWasPressed();
    }
    ...
    public override void ReleaseButton()
    {
        ...
        isPressed = false;
        app.Controller.RecordController.SaveTrailButtonWasReleased();
    }
}
